...
class Activity(models.Model):
    user_id = models.ForeignKey(User, related_name='CurrentUser', on_delete=models.CASCADE)
    sender_id = models.ForeignKey(User, related_name='SenderUser', on_delete=models.CASCADE)
...
class Friend(models.Model):
    user_id = models.ForeignKey(User, related_name='Current' ,on_delete=models.CASCADE, default=None)
    friend_id = models.ForeignKey(User, related_name='Friend' ,on_delete=models.CASCADE, default=None)
    group_id = models.ForeignKey(Group, on_delete=models.CASCADE, null=True, blank=True)
    status = models.CharField(max_length=20, default='PENDING')
