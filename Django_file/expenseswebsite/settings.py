...
EMAIL_HOST_USER = 'trackerexpense2@gmail.com'
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'trackerexpense2@gmail.com'
EMAIL_PORT = 587
EMAIL_HOST_PASSWORD = 'myic nksh colu vlsb'


CORS_ALLOWED_ORIGINS = [
    'http://127.0.0.1:8000',  # Add other allowed origins if needed
]
